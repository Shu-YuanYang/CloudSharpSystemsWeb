...
*/
import TaskStatusMonitorChartBase from "./TaskStatusMonitorChartBase";


const TaskStatusMonitorCloudSharpChart = ({ title, refreshTriggered }) => {
    /*
    ...
    */
    return (
        <TaskStatusMonitorChartBase title={title} refreshTriggered={refreshTriggered} app_id={"CloudSharpTaskManager"} />
    )
};

export default TaskStatusMonitorCloudSharpChart;
