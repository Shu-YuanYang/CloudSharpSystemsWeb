...
const TaskStatusMonitorCyberlinaChart = ({ title, refreshTriggered }) => {
    /*
    ...
    */
    return (
        <TaskStatusMonitorChartBase title={title} refreshTriggered={refreshTriggered} app_id={"CyberlinaTaskManager"} />
    )
};

export default TaskStatusMonitorCyberlinaChart;
